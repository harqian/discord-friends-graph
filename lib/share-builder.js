...
(function (global) {
  ...
  function buildShareEnvelope(connections, opts) {
    ...
    const hideProfileLinks = Boolean(options.hideProfileLinks);
  ...
  function validateShareEnvelope(envelope) {
    ...
    if (envelope.kind !== 'discord-friends-graph-share') throw new Error('Not a Discord Friends Graph share envelope');
  ...
  function mergeEnvelopes(theirs, ours, opts) {
    ...
    return {
      ...
      obfuscation: {
        ...
        hideProfileLinks: Boolean((theirs.obfuscation && theirs.obfuscation.hideProfileLinks) && (ours.obfuscation && ours.obfuscation.hideProfileLinks)),
  ...
  global.DiscordFriendsGraphBuilder = api;
